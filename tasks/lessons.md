...
2026-04-07 - In this repo, the generated README should link problem mentions to their repo files and category mentions to their repo directories, and it should not include a separate repo path column when those links already provide navigation.
